...
public class StockAvroBean extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7867293539093435578L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StockAvroBean\",\"namespace\":\"com.jacle.serialization.avsc\",\"fields\":[{\"name\":\"stockCode\",\"type\":[\"string\",\"null\"]},{\"name\":\"stockName\",\"type\":\"string\"},{\"name\":\"tradeTime\",\"type\":\"long\"},{\"name\":\"preclosePrice\",\"type\":[\"float\",\"null\"]},{\"name\":\"openPrice\",\"type\":\"float\"},{\"name\":\"currentPrice\",\"type\":\"float\"}]}");
  ...
  @Deprecated public java.lang.Float preclosePrice;
   ...
   */
  public static com.jacle.serialization.avsc.StockAvroBean.Builder newBuilder() {
    return new com.jacle.serialization.avsc.StockAvroBean.Builder();
  }
   ...
   * @return A new StockAvroBean RecordBuilder
   */
  public static com.jacle.serialization.avsc.StockAvroBean.Builder newBuilder(com.jacle.serialization.avsc.StockAvroBean.Builder other) {
    return new com.jacle.serialization.avsc.StockAvroBean.Builder(other);
  }
   ...
   * @return A new StockAvroBean RecordBuilder
   */
  public static com.jacle.serialization.avsc.StockAvroBean.Builder newBuilder(com.jacle.serialization.avsc.StockAvroBean other) {
    return new com.jacle.serialization.avsc.StockAvroBean.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StockAvroBean>
    ...
    private java.lang.Float preclosePrice;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.jacle.serialization.avsc.StockAvroBean.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.jacle.serialization.avsc.StockAvroBean other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.stockCode)) {
        this.stockCode = data().deepCopy(fields()[0].schema(), other.stockCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder setStockCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder clearStockCode() {
      stockCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder setStockName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder clearStockName() {
      stockName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder setTradeTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder clearTradeTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder setPreclosePrice(java.lang.Float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder clearPreclosePrice() {
      preclosePrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder setOpenPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder clearOpenPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder setCurrentPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.jacle.serialization.avsc.StockAvroBean.Builder clearCurrentPrice() {
